...
export function CustomersPage() {
  ...
  const customers = useQuery({ queryKey: ['customers', search], queryFn: async () => (await api.get<ApiCollection<Customer>>('/customers', { params: { search } })).data })
