...
export function ConsignorsPage() {
  ...
  const query = useQuery({ queryKey: ['consignors', search], queryFn: async () => (await api.get<ApiCollection<Consignor>>('/consignors', { params: { search, per_page: 100 } })).data })
